...
const App = () => {
  ...
  const API_KEY = "392d21b95a70997d0c6c5904d30d03de";
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex items-center justify-center p-6 min-h-screen">
        <div className="bg-transparent backdrop-filter backdrop-blur-md rounded-xl shadow-2xl p-8 max-w-md text-white w-full border border-white/30 z-10">
          ...
          {!weather ? (
                ...
                <div className="absolute top-12 left-0 right-0 bg-transparent shadow-md rounded z-10">
                  {suggestions.map((s) => (
                    <button
                      ...
                      className="block hover:bg-blue-700 bg-transparent px-4 py-4 text-sm text-left w-full transition-colors"
                    >
                      {s.name}, {s.country}
                      {s.state && `, ${s.state}`}
                    </button>
            ...
            <div className="mt-6 text-center transition-opacity duration-500">
              <button
                ...
                className="mb-4 bg-purple-900 hover:bg-blue-700 text-white font-semi-bold py-1 px-3 rounded transition-colors"
              >
                New Search
              </button>
